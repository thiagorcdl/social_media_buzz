...
On the other hand, when applying the models to the testing data, the highest ranked feature is Number of Authors on its fifth, sixth and fourth observations, respectively. The attributes that generated the most accurate models differ almost significantly. Only four out of the ten best attributes from Table 1 are represented again in Table 2. If we were to pick only the top 5, there would be no recurring attribute at all.\selectlanguage{english}
\begin{table}[h!]
\centering
